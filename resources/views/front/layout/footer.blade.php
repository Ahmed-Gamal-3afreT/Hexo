        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="logo footer-logo">
                    <a title="fontanero" href="index.html">
                        <img src="{{asset('/asset/front')}}/img/tech_about.jpg" alt="technews">
                    </a>
            ...
            <div class="col-md-3">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/editor_pic1.jpg"
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/editor_pic2.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/editor_pic3.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
            ...
            <div class="col-md-3">
                ...
                <div class="widget_photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo1.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo2.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo3.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo4.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo5.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo6.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo7.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo8.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo9.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo10.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo11.jpg" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{asset('/asset/front')}}/img/tech_photo12.jpg" alt="Tech Photos">
                </div>
