        ...
        <div class="row">
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="{{asset('/asset/front')}}/img/feature-top.jpg"
                             alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/feature-static1.jpg" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/feature-static2.jpg" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-6">
                <div class="top_article_img">
                    <a href="single.html" target="_self"><img class="img-responsive"
                                                               src="{{asset('/asset/front')}}/img/cat-mobi-left-1.jpg" alt="feature-top">
                    </a>
                </div>
                <!----top_article_img------>
            </div>
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/cat-mobi-sm1.jpg"
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/cat-mobi-sm3.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">Mobile</span>
            ...
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/cat-mobi-sm2.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">Mobile</span>
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/cat-mobi-sm4.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">Mobile</span>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self"><img class="img-responsive" src="{{asset('/asset/front')}}/img/tab_top1.jpg"
                                                                   alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
                ...
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{asset('/asset/front')}}/img/tab_top2.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{asset('/asset/front')}}/img/gad_top1.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
            ...
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/gad_top2.jpg" alt="feature-top">
                    </div>
                    <!-- top_article_img -->
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="top_article_img">
                    <a href="single.html" target="_self">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/cam_left1.jpg" alt="feature-top">
                    </a>
                </div>
                <!-- top_article_img -->
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="top_article_img">
                    <a href="single.html" target="_self">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/cam_left2.jpg" alt="feature-top">
                    </a>
                </div>
                <!-- top_article_img -->
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="top_article_img">
                    <a href="single.html" target="_self">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/cam_left3.jpg" alt="feature-top">
                    </a>
                </div>
                <!-- media_social -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{asset('/asset/front')}}/img/design_top1.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
            ...
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{asset('/asset/front')}}/img/design_top2.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{asset('/asset/front')}}/img/design_top3.jpg" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
            ...
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <img class="img-responsive" src="{{asset('/asset/front')}}/img/design_top4.jpg" alt="feature-top">
                    </div>
                    <!-- top_article_img -->
...
<div class="widget">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/pop_right1.jpg" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/pop_right2.jpg" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/pop_right3.jpg" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{asset('/asset/front')}}/img/pop_right4.jpg" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
...
<div class="widget hidden-xs m30">
    <img class="img-responsive adv_img" src="{{asset('/asset/front')}}/img/right_add1.jpg" alt="add_one">
    <img class="img-responsive adv_img" src="{{asset('/asset/front')}}/img/right_add2.jpg" alt="add_one">
    <img class="img-responsive adv_img" src="{{asset('/asset/front')}}/img/right_add3.jpg" alt="add_one">
    <img class="img-responsive adv_img" src="{{asset('/asset/front')}}/img/right_add4.jpg" alt="add_one">
</div>
<!-- Advertisement -->

<div class="widget hidden-xs m30">
    <img class="img-responsive widget_img" src="{{asset('/asset/front')}}/img/right_add5.jpg" alt="add_one">
</div>
<!-- Advertisement -->
...
<div class="widget hidden-xs m30">
    <img class="img-responsive widget_img" src="{{asset('/asset/front')}}/img/right_add6.jpg" alt="add_one">
</div>
<!-- Advertisement -->
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{asset('/asset/front')}}/img/editor.jpg"
...
<div class="widget hidden-xs m30">
    <img class="img-responsive add_img" src="{{asset('/asset/front')}}/img/right_add7.jpg" alt="add_one">
    <img class="img-responsive add_img" src="{{asset('/asset/front')}}/img/right_add7.jpg" alt="add_one">
    <img class="img-responsive add_img" src="{{asset('/asset/front')}}/img/right_add7.jpg" alt="add_one">
    <img class="img-responsive add_img" src="{{asset('/asset/front')}}/img/right_add7.jpg" alt="add_one">
</div>
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{asset('/asset/front')}}/img/reader.jpg"
                                  alt="Generic placeholder image">
...
<div class="widget hidden-xs m30">
    <img class="img-responsive widget_img" src="{{asset('/asset/front')}}/img/podcast.jpg" alt="add_one">
</div>
<!--Advertisement-->
</div>
<!-- Right Section -->
