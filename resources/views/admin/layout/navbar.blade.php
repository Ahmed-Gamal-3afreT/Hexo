            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    ...
                    <div class="header-left">
                       ...
                       <a class="navbar-brand" href="./"><img style="width:100px;" src="{{asset('/asset/admin')}}/images/logo6.png" alt="Logo"></a>
                        ...
                        <div class="dropdown for-message">
                          ...
                          <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{asset('/asset/admin')}}/images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{asset('/asset/admin')}}/images/avatar/2.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-5" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{asset('/asset/admin')}}/images/avatar/3.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{asset('/asset/admin')}}/images/avatar/4.jpg"></span>
                                <span class="message media-body">
