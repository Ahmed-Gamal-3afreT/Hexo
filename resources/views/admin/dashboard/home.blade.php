            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count">{{$allUsers->count()}}</span>
                        </h4>
                        <p class="text-light">ALL Members</p>
           ...
           <div class="col-xl-3 col-lg-6">
                <section class="card">
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            <a href="#">
                                <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="{{asset('/asset/admin')}}/images/admin.jpg">
                            </a>
